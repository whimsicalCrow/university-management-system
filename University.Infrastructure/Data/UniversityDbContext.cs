...
public class UniversityDbContext : IdentityDbContext<IdentityUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Professor>().HasData(
            new { Id = 1, UserId = "prof-1", Department = "Computer Science", Expertise = "Machine Learning" },
            new { Id = 2, UserId = "prof-2", Department = "Mathematics", Expertise = "Algebra" },
            new { Id = 3, UserId = "prof-3", Department = "Physics", Expertise = "Quantum" },
            new { Id = 4, UserId = "prof-4", Department = "Chemistry", Expertise = "Organic" },
            new { Id = 5, UserId = "prof-5", Department = "Biology", Expertise = "Genetics" }
        );
