    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThesisUpdates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ThesisUpdates_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Feedback_ThesisUpdates_UpdateId",
                        column: x => x.UpdateId,
                        principalTable: "ThesisUpdates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_StudentId_ProfessorId",
                table: "Assignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ThesisUpdates_StudentId",
                table: "ThesisUpdates",
                column: "StudentId");
        }
